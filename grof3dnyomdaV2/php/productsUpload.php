...
if (isset($_POST['submit'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        <?php
            ...
            session_start();
            $SESSION[\'productName\'] = \''.$_POST['product_name'].'\';
        ?>
            ...
            <body>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <img src="../img/'.$pageName.'.png" alt="">
                            ...
                            <ul>
                                ...
                                <li><b>Termék ára (1 darab):</b> '.$_POST['product_price'].'</li>
                                <li><b>Termék alapanyaga:</b>  '.$_POST['product_material'].'</li>
                                <li><b>Termék színe: </b>'.$_POST['product_color'].'</li>
                                <li><b>Termék szélessége: </b>'.$width.'</li>
                                <li><b> termék hosszúság</b>'.$height.'</li>
                                <li><b>Termék magasság: </b>'.$length.'</li>
                            </ul>
                    </div>
                    <div class="col-sm-12 col-md-8 col-lg-8">
                        ...
                        <p> Összesen: <span id="productPrize">'.$_POST['product_price'].'</span> Ft</P>
                    </div>
