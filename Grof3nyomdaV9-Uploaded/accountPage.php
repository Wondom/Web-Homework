...
<head>
    ...
    <title>Gróf3DNyomda - Account </title>
</head>
...
<body>
    ...
    <h1 class="fs-1 text text-center font-monospace shadow p-3 mb-5 bg-body-tertiary rounded">Account</h1>
    <h2 class="text-uppercase text-center fs-3 text shadow-sm p-3 mb-5 bg-body-tertiary rounded"><?php echo $_SESSION['user_name'];?></h2>
    <div class="row">
        <div class="col-sm-12 col-md-6 col-lg-6">
            <h3 class="text-uppercase fs-5 text shadow-sm p-3 mb-5 bg-body-tertiary rounded">Change password</h3>
            <form action="php/change.php">
                <input class="form-control form-contol-lg" style="margin-bottom:20px;" type="password" name="newPassword" id="newPassWord" placeholder="New Password">
                <input class="form-control form-contol-lg" type="password" name="newPasswordR" id="newPassWordR" placeholder="New Password again">
                <div class="d-grid gap-2" style="margin-top:20px">
                    <input name="submitPassword" value="Change Password" class="btn btn-primary" type="submit" id="submit">
                </div>
               
            </form>
        </div>
        <div class="col-sm-12 col-md-6 col-lg-6">
        <h3 class="text-uppercase fs-5 text shadow-sm p-3 mb-5 bg-body-tertiary rounded">Change firstname</h3>
            <form action="php/change.php" method="POST">
                <input class="form-control form-contol-lg" type="text" name="firstNameChange" id="firstNameChange" placeholder="Change FirstName" />
                <div class="d-grid gap-2" style="margin-top:20px">
                <input class="btn btn-primary" type="submit" name="submitFirstName" value="Change Firstname" />
                </div>
        </form>
        </div>
        <div class="col-sm-12 col-md-6 col-lg-6">
        <h3 class="text-uppercase fs-5 text shadow-sm p-3 mb-5 bg-body-tertiary rounded">Change lastname</h3>
        <form action="php/change.php" method="POST">
            <input class="form-control form-contol-lg" type="text" name="lastNameChange" id="lastNameChange" placeholder="Change LastName" />
            <div class="d-grid gap-2" style="margin-top:20px">
            <input class="btn btn-primary"  type="submit" name="submitLastName" value="Change Lastname" />
                </div>
        </form>  
        </div>
        <div class="col-sm-12 col-md-6 col-lg-6">
        <h3 class="text-uppercase fs-5 text shadow-sm p-3 mb-5 bg-body-tertiary rounded">Change phone number</h3>
        <form action="php/change.php" method="POST">
            <input class="form-control form-contol-lg"  type="text" name="phoneChange" id="phoneChane" placeholder="Change Phonenumber" />
            <div class="d-grid gap-2" style="margin-top:20px">
            <input class="btn btn-primary" type="submit" name="submitPhone" value="Change Phonenumber" />
            </div>
        </form>
        </div>
        
        <div class="col-sm-12 col-md-6 col-lg-6">
        <h3 class="text-uppercase fs-5 text shadow-sm p-3 mb-5 bg-body-tertiary rounded">Change email address</h3> 
        <form action="php/change.php" method="POST">
            <input class="form-control form-contol-lg" type="email" name="emailChange" id="emailChane" placeholder="Change Email" />
            <div class="d-grid gap-2" style="margin-top:20px">
            <input class="btn btn-primary" type="submit" name="submitEmail" value="Change Email" />
                </div>
        </form></div>
    </div>
        <a style="float:right" href="php/deleteAccount.php"> Delete my account! </a>
    </div>
</body>
</html>
