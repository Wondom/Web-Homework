...
?>
<!DOCTYPE html>
<html lang="en" id="html" data-bs-theme="<?php echo $_SESSION['color'] ;?>">
<head>
    <meta charset="UTF-8">
    ...
    <div class="row">
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <div class="card col-sm-12 col-md-3 col-lg-3">
                <img class="card-img-top"  src="img/' . $row['product_img'] . '" alt="termék" title="termékl"/>                    
                <div class="card-body">
