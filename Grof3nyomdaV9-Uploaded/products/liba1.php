            ...
            <a href="../php/logoff.php" class="btrap-icons">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <img src="../img/letöltés (1).jpg" class="img-thumbnail">
                            <h2 class="text-uppercase fs-3 text shadow-sm p-3 mb-5 bg-body-tertiary rounded">A termék adatai: </h2>
                            <ul class="list-group">
                                <li class="list-group-item"><b>Termék megnevezése:</b>liba1 </li>
                                <li class="list-group-item"><b>Termék ára (1 darab):</b> 1000Ft-</li>
                                <li class="list-group-item"><b>Termék alapanyaga:</b>  lila</li>
                                <li class="list-group-item"><b>Termék színe: </b>lilaa</li>
                                <li class="list-group-item"><b>Termék szélessége: </b>nullcm</li>
                                <li class="list-group-item"><b> termék hosszúság</b>nullcm</li>
                                <li class="list-group-item"><b>Termék magasság: </b>nullcm</li>
                            </ul>
                    </div>
                    <div class="col-sm-12 col-md-8 col-lg-8">
                        <h1  class="fs-1 text text-center font-monospace shadow p-3 mb-5 bg-body-tertiary rounded" style="margin-top:10px">liba1</h1>
                        ...
                        <form action="../php/order.php" method="POST">
                            <input type="hidden" name="img" value=letöltés (1).jpg />    
                            ...
                            <input class="form-control form-control-lg disable" name="productPrize" id="productPrize" value="1000" readonly>
