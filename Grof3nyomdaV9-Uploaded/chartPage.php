...
<meta charset="UTF-8">
    ...
    <title>gRÓF 3d Nyomda - Chart</title>
</head>
...
<nav class="navbar sticky-top navbar-expand-lg bg-body-tertiary">
  ...
  <div class="row">
      ...
      foreach ($_SESSION['CHART'] as $minarray) {
        ...
        echo '
          ...
          <form action="php/dropElement.php" method="POST">
            <div class="row g-0">
            <div class="col-md-4">
              <img src="img/'.$minarray[3].'" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
            <div class="card-body">
            <input style="float:right" class="btn btn-danger" type="submit" name="" value="DROP" id="image-button">
            <h2 class="card-title">'.$minarray[0].'</h2>
            
            <p class="card-text"> <p>'.$minarray[1].' db -  HUF '. $minarray[2] . '</p>
            </div>
    ...
    <h1 class="fs-1 text text-center font-monospace shadow p-3 mb-5 bg-body-tertiary rounded" style="margin-top:10px">Finalize your order</h1>  
    <form action="finalizeOrderPage.php" method="POST"> 
        <label class="form-label" for="total">Végösszeg</label>
        <input class="form-control form-control-lg" type="number" name="total" id="total" value="<?php
          $total  = 0;
      ...
      <div class="d-grid gap-2" style="margin-top:20px">
        <input class="btn btn-primary " type="submit" name="submit" id="submit" value="ORDER">
      </div>
    </form>
    </div>
  </div>
