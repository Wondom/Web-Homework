                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <img src="../img/' . $productImg . '" class="img-thumbnail">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item"><b>Product name</b>' . $_POST['product_name'] . ' </li>
                                <li class="list-group-item"><b>Product price:</b> ' . $_POST['product_price'] . 'Ft-</li>
                                <li class="list-group-item"><b>Product material</b>  ' . $_POST['product_material'] . '</li>
                                <li class="list-group-item"><b>TProduct color: </b>' . $_POST['product_color'] . '</li>
                                <li class="list-group-item"><b>TProduct width: </b>' . $productWidth . 'cm</li>
                                <li class="list-group-item"><b> TProduct height</b>' .$productHeigth. 'cm</li>
                                <li class="list-group-item"><b>TProduct lenght: </b>' . $productlength . 'cm</li>
                            </ul>
                    </div>
                    <div class="col-sm-12 col-md-8 col-lg-8">
                        ...
                        <h2 class="text-uppercase fs-3 text shadow-sm p-3 mb-5 bg-body-tertiary rounded">Order it now!</h2>
