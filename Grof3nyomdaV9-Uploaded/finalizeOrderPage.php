...
<nav class="navbar sticky-top navbar-expand-lg bg-body-tertiary">
    ...
    <form class="w-75 p-3" style="margin:auto" action="php/finalizeOrder.php" method="POST">
    <?php
        
        if (!(isset($_SESSION['logged']) and $_SESSION['logged'] == true)) {
            $userName = 'quest';
            echo '<h2>Enter your name to complete your order.</h2>
                <input class="form-control form-control-lg" type="text" name="firstNameQuest" placeholder="Firstname" required/>
                <input class="form-control form-control-lg" type="text" name="lastNameQuest" placeholder="Lastname" required/>      
                <input class="form-control form-control-lg" type="email" name="emailQuest" placeholder="Email-address" required />      
            ';
        }
