...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO products VALUES('$productName',$productPrice, '$productMaterial', '$productColor',$productWidth , $productHeigth,$productlength )";
            ...
            ?>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <img src="../img/' . $_POST['product_name'] . '.png" alt="">
                            <h2>A termék adatai: </h2>
                            <ul>
                                <li><b>Termék megnevezése:</b>' . $_POST['product_name'] . ' </li>
                                <li><b>Termék ára (1 darab):</b> ' . $_POST['product_price'] . 'Ft-</li>
                                <li><b>Termék alapanyaga:</b>  ' . $_POST['product_material'] . '</li>
                                <li><b>Termék színe: </b>' . $_POST['product_color'] . '</li>
                                <li><b>Termék szélessége: </b>' . $width . 'cm</li>
                                <li><b> termék hosszúság</b>' . $height . 'cm</li>
                                <li><b>Termék magasság: </b>' . $length . 'cm</li>
                            </ul>
                    </div>
                    <div class="col-sm-12 col-md-8 col-lg-8">
                        ...
                        <form action="../php/order.php" method="POST">
                            ...
                            <input name="productPrize" id="productPrize" value="' . $_POST['product_price'] . '" readonly>
    ...
    ';
        ...
        header('location:../productUploadPage.php');
    } 
}
?>