        ...
        <?php
            ...
            $_SESSION['productName'] = 'mostjoleszakep';
        ?>
        <!DOCTYPE html>
        <html lang="en">
            <head>
            ...
            ?>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <img src="../img/hell.jpg.png" alt="">
                            <h2>A termék adatai: </h2>
                            <ul>
                                <li><b>Termék megnevezése:</b>mostjoleszakep </li>
                                <li><b>Termék ára (1 darab):</b> 111111Ft-</li>
                                <li><b>Termék alapanyaga:</b>  Lala</li>
                                <li><b>Termék színe: </b>ld,</li>
                    ...
                    <div class="col-sm-12 col-md-8 col-lg-8">
                        ...
                        <form action="../php/order.php" method="POST">
                            ...
                            <input name="productPrize" id="productPrize" value="111111" readonly>
