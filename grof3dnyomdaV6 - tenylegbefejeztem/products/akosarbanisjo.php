        ...
        <?php
            ...
            $_SESSION['productName'] = 'akosarbanisjo';
        ?>
        <!DOCTYPE html>
        <html lang="en">
            <head>
            ...
            ?>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <img src="../img/hell.png" alt="">
                            <h2>A termék adatai: </h2>
                            <ul>
                                <li><b>Termék megnevezése:</b>akosarbanisjo </li>
                                <li><b>Termék ára (1 darab):</b> 12Ft-</li>
                                <li><b>Termék alapanyaga:</b>  12</li>
                                <li><b>Termék színe: </b>12</li>
                    ...
                    <div class="col-sm-12 col-md-8 col-lg-8">
                        ...
                        <form action="../php/order.php" method="POST">
                            <input type="hidden" name="img" value=hell.png />    
                        <label for="productCount">Darabszám: </label>
                            ...
                            <input name="productPrize" id="productPrize" value="12" readonly>
