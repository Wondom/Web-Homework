        ...
        <?php
            ...
            $_SESSION['productName'] = 'mostmartenylegjolesz';
        ?>
        <!DOCTYPE html>
        <html lang="en">
            <head>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <img src="../img/hell.jpg" alt="">
                            ...
                            <ul>
                                <li><b>Termék megnevezése:</b>mostmartenylegjolesz </li>
                                <li><b>Termék ára (1 darab):</b> 121Ft-</li>
                                <li><b>Termék alapanyaga:</b>  121</li>
                                <li><b>Termék színe: </b>121</li>
                    ...
                    <div class="col-sm-12 col-md-8 col-lg-8">
                        ...
                        <form action="../php/order.php" method="POST">
                            ...
                            <input name="productPrize" id="productPrize" value="121" readonly>
