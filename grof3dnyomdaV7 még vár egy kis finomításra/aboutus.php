...
<head id="html" lang="en" data-bs-theme="light">
    <meta charset="UTF-8">
...
<body>
    ...
    <div id="kozepre">
        <a href="https://www.instagram.com/grof3dnyomda/" target=_blank><img src="img/instagram.png" alt="instagram"
                width="40px" height="40px"></a>
        <a href="https://www.facebook.com/andras.feszki" target=_blank>
            <img src="img/facebook.png" alt="facebook" width="40px" height="40px"></a>
        <img src="img/email.png" alt="email" width="40px" height="40px">
        <p>grof.3dnyomda@gmail.com</p>
        <iframe
