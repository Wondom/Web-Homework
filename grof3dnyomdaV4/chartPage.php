...
<body>
  <nav class="navbar sticky-top navbar-expand-sm">
    <ul class="navbar-nav col-sm">
      <li class="nav-item"><a class="nav-link" href="homePage.php"><svg xmlns="http://www.w3.org/2000/svg" width="16"
            height="16" class="bi bi-house-door-fill" viewBox="0 0 16 16">
            <path
    ...
    <a href="chartPage.php" class="btrap-icons">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-basket-fill" viewBox="0 0 16 16">
        <path
  ...
  <div class="row">
    <div class="col-sm-12 col-md-8 col-lg-8">
      <?php
      $index = 0;
      foreach ($_SESSION['CHART'] as $minarray) {

        echo '
          <div class="row orderedItem"> 
            <div class="col-sm-12 col-md-3 col-lg-3 orederedItemImg">
              <form action="php/dropElement.php" method="POST">
                <input type = "hidden" name = "dropElementIndex" value = "' . $index . '" />
                <input type="submit" name="" value="X" id="image-button">
              </form> 
              <img src="img/' . $minarray[0] . '.png">
            </div>
            <div class="col-sm-12 col-md-3 col-lg-3 orderedItemName">
              <h2>' . $minarray[0] . '</h2>
            </div>
            <div class="col-sm-12 col-md-3 col-lg-3 orderedItemCount"> 
              <input type="number" width="5px" readonly value="' . $minarray[1] . '">
            </div>
            <div class="col-sm-12 col-md-3 col-lg-3 orederPrice"> 
              <p> HUF ' . $minarray[2] . '
            </div>
    ...
    <form action="finalizeOrderPage.php" method="POST"> 
        <label for="total">Végösszeg</label>
        <input type="number" name="total" id="total" value="<?php
          $total  = 0;
