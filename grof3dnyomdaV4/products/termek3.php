            ...
            ?>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <img src="../img/termek3.png" alt="">
                            <h2>A termék adatai: </h2>
                            <ul>
                                <li><b>Termék megnevezése:</b>termek3 </li>
                                <li><b>Termék ára (1 darab):</b> 20Ft-</li>
                                <li><b>Termék alapanyaga:</b>  banán</li>
                                <li><b>Termék színe: </b>sárga</li>
                                <li><b>Termék szélessége: </b>nullcm</li>
                                <li><b> termék hosszúság</b>nullcm</li>
                                <li><b>Termék magasság: </b>nullcm</li>
                            </ul>
                    </div>
                    <div class="col-sm-12 col-md-8 col-lg-8">
                        ...
                        <form action="../php/order.php" method="POST">
                            ...
                            <input name="productPrize" id="productPrize" value="20" readonly>
