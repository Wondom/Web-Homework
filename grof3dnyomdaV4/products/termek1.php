                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <img src="../img/termek1.png" alt="">
                            ...
                            <ul>
                                ...
                                <li><b>Termék ára (1 darab):</b> 10</li>
                                <li><b>Termék alapanyaga:</b>  als</li>
                                <li><b>Termék színe: </b>KÉK</li>
                                <li><b>Termék szélessége: </b>2</li>
                                <li><b> termék hosszúság</b>null</li>
                                <li><b>Termék magasság: </b>null</li>
                            </ul>
                    </div>
                    <div class="col-sm-12 col-md-8 col-lg-8">
                        ...
                        <form action="../php/order.php" method="POST">
                            ...
                            <label for="">Összesen: </label>
                            <input name="productPrize" id="productPrize" value="10" readonly>
                            <input class="btn" type="submit" name="submit">
                        </form>
                        <!--<p> Összesen: <span id="productPrize">10</span> Ft</P>-->
                    </div>
                    <div class=" col-sm-12 col-md-12 col-lg-12 messageDiv">
                    <form action="../php/newMessage.php" method="POST">
                        <textarea class="form-control"name="messagesTA" id="messagesTA" cols="1" rows="10" wrap="hard" readonly>
                    <?php 
                        @include '../php/config.php';
