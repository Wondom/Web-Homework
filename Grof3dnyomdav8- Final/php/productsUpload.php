...
if (isset($_POST['submit'])) {
    ...
    $_SESSION["imgName"] = $_FILES['product_img']['name'];
    $productPrice = $_POST['product_price'];
    $productMaterial = $_POST['product_material'];
    $productColor = $_POST['product_color'];
    $productWidth = $_POST['product_width'];
    $productHeigth = $_POST['product_height'];
    $productlength = $_POST['product_length'];
    if ($productWidth == '') {
        $productWidth = 'null';
    }
    if ($productHeigth == '') {
    ...
    $target_path = "../img/";  
    $target_path = $target_path.basename( $_FILES['product_img']['name']);   
    ...
    $sql = "INSERT INTO products VALUES('$productName','$productImg', $productPrice, '$productMaterial', '$productColor',$productWidth , $productHeigth,$productlength )";
    if ($conn->query($sql) === TRUE) {
        $mappa = "../products/";

        $pageName = $_POST['product_name'] . ".php";
        $pageName = str_replace(' ', '_', $pageName);
        $pageName = str_replace('-', '_', $pageName);
        $fajlnev = fopen($pageName, "w");
        $oldalszoveg = '
        <?php
        ...
        function lightordark() {
            ...
            <a href="../php/logoff.php" class="btrap-icons">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <img src="../img/' . $productImg . '" class="img-thumbnail">
                            <h2 class="text-uppercase fs-3 text shadow-sm p-3 mb-5 bg-body-tertiary rounded">A termék adatai: </h2>
                            <ul class="list-group">
                                <li class="list-group-item"><b>Termék megnevezése:</b>' . $_POST['product_name'] . ' </li>
                                <li class="list-group-item"><b>Termék ára (1 darab):</b> ' . $_POST['product_price'] . 'Ft-</li>
                                <li class="list-group-item"><b>Termék alapanyaga:</b>  ' . $_POST['product_material'] . '</li>
                                <li class="list-group-item"><b>Termék színe: </b>' . $_POST['product_color'] . '</li>
                                <li class="list-group-item"><b>Termék szélessége: </b>' . $productWidth . 'cm</li>
                                <li class="list-group-item"><b> termék hosszúság</b>' .$productHeigth. 'cm</li>
                                <li class="list-group-item"><b>Termék magasság: </b>' . $productlength . 'cm</li>
                            </ul>
                    </div>
                    <div class="col-sm-12 col-md-8 col-lg-8">
                        <h1  class="fs-1 text text-center font-monospace shadow p-3 mb-5 bg-body-tertiary rounded" style="margin-top:10px">' . $_POST['product_name'] . '</h1>
                        <h2 class="text-uppercase fs-3 text shadow-sm p-3 mb-5 bg-body-tertiary rounded">Rendeld meg most!</h2>
                        
                        <form action="../php/order.php" method="POST">
                            <input type="hidden" name="img" value='.$productImg.' />    
                            
                            <input class="form-control form-control-lg" type="number" onchange="priceChange()" name="productCount" id="productCount" value="1" placeholder="Number of pieces">
                            <label> Összesen: </lable>
                            <input class="form-control form-control-lg disable" name="productPrize" id="productPrize" value="' . $_POST['product_price'] . '" readonly>
            ...
            <input class="form-control form-control-lg" type="text" name="messageInput" id="messageInput" placeholder="Leave a comment here!" required>
            <div class="d-grid gap-2" style="margin-top:20px">
                <input class="btn btn-primary" type="submit" name="submit">
            </div>
        </form>
    ...
    ';
        ...
        rename($pageName, $mappa . $pageName);
        
        header('location:../productsUpload.php');
    } 
}
?>