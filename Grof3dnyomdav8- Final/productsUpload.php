...
<head>
    ...
    <title>Gróf 3D Nyomda - Product Upload</title>
</head>
<body>
    ...
    <h1  class="fs-1 text text-center font-monospace shadow p-3 mb-5 bg-body-tertiary rounded"
                style="margin-top:10px">Product upload</h1>
    <form action="php/productsUpload.php" enctype="multipart/form-data" method="POST" class="w-75 p-3" style="margin:auto">
        <input type="text" class="form-control form-control-lg" name="product_name" id="product_name"
            placeholder="Product name" required> <br />
        <div class="input-group" style="margin-bottom:20px">
            <input type="file" class="form-control" id="product_img" name="product_img" aria-describedby="inputGroupFileAddon04"
                aria-label="Upload">
        </div>
        <input type="number" class="form-control form-control-lg" name="product_price" id="product_price"
            placeholder="Product price" required> <br />

        <input type="text" name="product_material" class="form-control form-control-lg" id="product_material"
            placeholder="Product material" required> <br />

        <input type="text" name="product_color" class="form-control form-control-lg" id="product_color"
            placeholder="Product color" required> <br />

        <input type="number" name="product_width" class="form-control form-control-lg" id="product_width"
            placeholder="Product width"> <br />

        <input type="number" name="product_height" class="form-control form-control-lg" id="product_height"
            placeholder="Product height"> <br />

        <input type="number" name="product_length" class="form-control form-control-lg" id="product_lenght"
            placeholder="Product length"> <br />
