...
<body>
    ...
    <div class="container">
        ...
        <div class="mySlides">
            ...
            <img src="img/róka.png" style="width:100%">
        </div>

        <div class="mySlides">
            <div class="numbertext">2 / 6</div>
            <img src="img/lo.png" style="width:100%">
        </div>

        <div class="mySlides">
            <div class="numbertext">3 / 6</div>
            <img src="img/auto.png" style="width:100%">
        </div>

        <div class="mySlides">
            <div class="numbertext">4 / 6</div>
            <img src="img/liba.png" style="width:100%">
        </div>

        <div class="mySlides">
            <div class="numbertext">5 / 6</div>
            <img src="img/szobor.png" style="width:100%">
        </div>

        <div class="mySlides">
            <div class="numbertext">6 / 6</div>
            <img src="img/vaza.png" style="width:100%">
        </div>
        ...
        <div class="row">
            <div class="column">
                <img class="demo cursor" src="img/róka.png" style="width:100%" onclick="currentSlide(1)"
                    alt="Dobby szabad manó">
            </div>
            <div class="column">
                <img class="demo cursor" src="img/lo.png" style="width:100%" onclick="currentSlide(2)"
                    alt="Festett ló szobor">
            </div>
            <div class="column">
                <img class="demo cursor" src="img/auto.png" style="width:100%" onclick="currentSlide(3)"
                    alt="Auto oldalnézettben">
            </div>
            <div class="column">
                <img class="demo cursor" src="img/liba.png" style="width:100%" onclick="currentSlide(4)"
                    alt="Peace was never an option">
            </div>
            <div class="column">
                <img class="demo cursor" src="img/szobor.png" style="width:100%" onclick="currentSlide(5)"
                    alt="Mell szobor">
            </div>
            <div class="column">
                <img class="demo cursor" src="img/vaza.png" style="width:100%" onclick="currentSlide(6)" alt="Váza">
            </div>
        </div>
    </div>
