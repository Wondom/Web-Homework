            ...
            <a href="../php/logoff.php" class="btrap-icons">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <img src="../img/liba.png" class="img-thumbnail">
                            <h2 class="text-uppercase fs-3 text shadow-sm p-3 mb-5 bg-body-tertiary rounded">A termék adatai: </h2>
                            <ul class="list-group">
                                <li class="list-group-item"><b>Termék megnevezése:</b>liba </li>
                                <li class="list-group-item"><b>Termék ára (1 darab):</b> 1000Ft-</li>
                                <li class="list-group-item"><b>Termék alapanyaga:</b>  Lala</li>
                                <li class="list-group-item"><b>Termék színe: </b>123</li>
                                <li class="list-group-item"><b>Termék szélessége: </b>10cm</li>
                                <li class="list-group-item"><b> termék hosszúság</b>10cm</li>
                                <li class="list-group-item"><b>Termék magasság: </b>10cm</li>
                            </ul>
                    </div>
                    <div class="col-sm-12 col-md-8 col-lg-8">
                        <h1  class="fs-1 text text-center font-monospace shadow p-3 mb-5 bg-body-tertiary rounded" style="margin-top:10px">liba</h1>
                        ...
                        <form action="../php/order.php" method="POST">
                            <input type="hidden" name="img" value=liba.png />    
