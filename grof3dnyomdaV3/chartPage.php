...
function dropChartElement($index)
{
      ...
      foreach ($_SESSION['CHART'] as $minarray) {
        ...
        echo '
          <div class="row orderedItem"> 
            <div class="col-3 orederedItemImg">
            ...
            <div class="col-3 orderedItemName">
              <h2>'.$minarray[0].'</h2>
            </div>
            <div class="col-3 orderedItemCount"> 
              <input type="number" width="5px" readonly value="'.$minarray[1].'">
            </div>
            <div class="col-3 orederPrice"> 
              <p> HUF '.$minarray[2].'
            </div>
